<template>
    <div>
        ...
        <div class="min-h-screen">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        <div class="flex items-center px-4">
                            <div v-if="$page.props.jetstream.managesProfilePhotos" class="flex-shrink-0 ml-3" >
            ...
            <main>
                <div class="alert">
                    <success-message v-if="$page.props.flash.success" :message="$page.props.flash.success" />
                </div>
                <slot></slot>
            </main>
        </div>
...
<script>
    ...
    import SuccessMessage from "@/Jetstream/SuccessMessage";
